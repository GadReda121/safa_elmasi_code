...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'dialCode' => 'رمز اتصال الدولة',
        'countryName' => 'اسم الدولة',
        'link' => ' ',
        'slug' => ' ',
        'commercial_name' => 'الإسم التجاري',
        'commercial_email' => 'الإيميل التجاري',
        'commercial_number' => 'رقم السجل التجاري',
        'commercial_tax_number' => 'الرقم الضريبي',
        'commercial_phone' => 'الرقم الجوال',
        'section_id' => 'القسم ',
        'attachments' => 'المرفقات',
        'tax_number' => 'الرقم الضريبي',
        'current_password' => 'رقم المرور الحالي',
        ...
        'items' => 'العناصر',
        'additions' => 'الإضافات',
        'price_item' => 'سعر العنصر',
        'replaces' => 'عناصر التبديل',
        'city_id' => 'المدينة',
        'state_id' => 'الحي',
        'workHour' => 'ساعات العمل',
        'workHour.*.from' => 'من',
        'workHour.*.to' => 'إلى',
        'personPrice' => 'السعر لكل شخص',
